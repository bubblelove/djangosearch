...
from .forms import RegisterForm, LoginForm, ChangePasswordForm, AuthorForm, RecommendForm, AdviceForm, BbsForm, CommentForm, SearchForm, SearchAuthorForm
...
def index(request):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			search = Ebook.objects.filter(name__contains=search_name)
			return render(request, 'share/results.html', {'search': search, })
	else:
		form = SearchForm()
